			...
			<div class="row">
				...
				<div class="col-sm">
					...
					<ul style="list-style: none; margin: 0; padding: 0">
						<li style="display: inline;"><img src="/img/icon/Facebook.png"></li>
						<li style="display: inline;"><img src="/img/icon/Twitter.png"></li>
						<li style="display: inline;"><img src="/img/icon/Ig.png"></li>
						<li style="display: inline;"><img src="/img/icon/Youtube.png"></li>
					</ul>
				</div>
			</div>
		</div>
